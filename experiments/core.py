...
def run_script(run_args: RunArgs) -> Result:
    domain_file, problem_file, _service_condition, action_mode, heuristic, planner_args, timeout = run_args.tolist()
...
def save_results(tmpdirpath: Path, output_dir: Path, run_args: RunArgs, result: Result) -> None:
    ...
    service_accepting_condition_filepath = run_args.service_accepting_condition_filepath
